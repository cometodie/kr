...
class User implements UserInterface{
     ...
     * Add bid
     *
     * @param \Blogger\BlogBundle\Entity\bid $bid
     *
     * @return User
     */
    public function addBid(\Blogger\BlogBundle\Entity\bid $bid)
    {
        $this->bids[] = $bid;
     ...
     * @param \Blogger\BlogBundle\Entity\bid $bid
     */
    public function removeBid(\Blogger\BlogBundle\Entity\bid $bid)
    {
